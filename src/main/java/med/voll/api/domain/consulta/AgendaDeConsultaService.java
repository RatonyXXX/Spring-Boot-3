...
import med.voll.api.domain.consulta.cancelar.ValidadorCancelarConsultas;
...
public class AgendaDeConsultaService {
    ...
    @Autowired
    List<ValidadorCancelarConsultas> validadoresCancelar;
    ...
    public void cancelarConsulta(DatosCancelarConsulta datos) {
        ...
        consulta.cancelarConsulta(datos.motivo());
